...
alias pacclear='pacman -Rnsc (pacman -Qtdq); yay -Qdt'
alias pacfix='sudo rm -f /var/lib/pacman/db.lck ;and pacman -Syyuu'
alias yr='yay'
alias yrs='yay -S'
alias yrsy='yay -S --noconfirm'
...
# alias up='pacman -Syu'
alias up='upmiror ;and pacman -Sy archlinux-keyring --noconfirm ;and yay -Syua ;and pacman -Sc'
alias upy='upmiror ;and pacman -Sy archlinux-keyring --noconfirm ;and yay -Syua --noconfirm ;and pacman -Sc --noconfirm'
alias upi='pacman -Qu'
